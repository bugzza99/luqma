...
@riverpod
class AdminConfig extends _$AdminConfig {
  @override
...
class ConfigActions extends _$ConfigActions {
  ...
  Future<Result<Map<String, Object>>> save(Map<String, Object> values) async {
    final result = await ref.read(configRepositoryProvider).setValues(values);
    if (result case Ok(:final value)) {
      ref.read(adminConfigProvider.notifier).replace(value);
    }
    return result;
  }
}
